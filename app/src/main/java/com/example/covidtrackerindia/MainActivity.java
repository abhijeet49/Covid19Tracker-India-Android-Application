...
import com.example.covidtrackerindia.R;
import com.example.covidtrackerindia.recyclerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<com.example.covidtrackerindia.DistrictData> districtList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(MainActivity.this, R.layout.custom_spinner_item, statesName);
    ...
    private void getStateData(String stateName) {
        ...
        for (Map.Entry<String, JsonElement> district : districts) {
            ...
            districtList.add(new com.example.covidtrackerindia.DistrictData(district.getKey(), Integer.parseInt(confirmed.toString()), Integer.parseInt(active.toString()),
